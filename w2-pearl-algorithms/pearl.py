...
def make_table(words):
    ...
    duration = time.process_time() - start
    print("Time spent sorting words: " + str(round(duration * 1000000)))

    start = time.process_time()
    search_table = combine_sources(words)
    duration = time.process_time() - start
    print("Time spent combining sources. Taken time: " + str(round(duration * 1000000)))
...
def make_density_table(words):
    ...
    duration = time.process_time() - start
    print("Time spent storing sources: " + str(round(duration * 1000000)))
